...
public class NAND extends Gate {
    ...
    public NAND(Basic input1, Basic input2){
        super();
    ...
    public void init(Basic[] input1, Basic[] input2){
        ...
        p2 = new PMOS(new Basic[]{vpp}, input2);

        n1 = new NMOS(new Basic[]{ground}, input1);
        n2 = new NMOS(new Basic[]{n1}, input2);
        outputs = new Basic[]{p1, p2, n2};
    }
    ...
    public static void main(String[] args){
        ...
        NAND nand = new NAND(new Basic[]{Input1}, new Basic[]{Input2});
        Transistor out = new Output(nand.outputs);
